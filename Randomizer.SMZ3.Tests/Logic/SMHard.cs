...
namespace Randomizer.SMZ3.Tests.Logic {
    ...
    public class SMHard : SMNormal {
        ...
        protected override List<Case> YellowMaridiaWateringHole => new() {
            ...
            CaseWith(x => x.Morph.Bombs.HiJump.Ice.Grapple),
            CaseWith(x => x.Morph.Bombs.HiJump.SpringBall.Grapple),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.SpringBall.Sword.Cape.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.SpringBall.MasterSword.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.SpringBall.Hammer.Glove),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.SpringBall.Mitt),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.HiJump.Sword.Cape.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.HiJump.MasterSword.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.HiJump.Hammer.Glove),
            CaseWith(x => x.Morph.Bombs.MoonPearl.Flippers.HiJump.Mitt),
            CaseWith(x => x.Morph.PowerBomb.Gravity),
            CaseWith(x => x.Morph.PowerBomb.HiJump.Ice.Grapple),
            CaseWith(x => x.Morph.PowerBomb.HiJump.SpringBall.Grapple),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.SpringBall.Sword.Cape.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.SpringBall.MasterSword.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.SpringBall.Hammer.Glove),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.SpringBall.Mitt),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.HiJump.Sword.Cape.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.HiJump.MasterSword.Lamp.KeyCT(2)),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.HiJump.Hammer.Glove),
            CaseWith(x => x.Morph.PowerBomb.MoonPearl.Flippers.HiJump.Mitt),
        };
