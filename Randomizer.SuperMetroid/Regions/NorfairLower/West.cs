    ...
    class West : Region {
        ...
        public West(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, "Missile (Gold Torizo)", LocationType.Visible, 0x78E6E, Logic switch {
                ...
                new Location(this, "Super Missile (Gold Torizo)", LocationType.Hidden, 0x78E74, Logic switch {
                ...
                new Location(this, "Screw Attack", LocationType.Chozo, 0x79110, Logic switch {
