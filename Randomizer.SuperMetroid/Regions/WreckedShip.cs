    ...
    class WreckedShip : Region {
        ...
        public WreckedShip(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, 128, "Missile (Wrecked Ship middle)", LocationType.Visible, 0x7C265),
                new Location(this, 129, "Reserve Tank, Wrecked Ship", LocationType.Chozo, 0x7C2E9, Logic switch {
                ...
                new Location(this, 130, "Missile (Gravity Suit)", LocationType.Visible, 0x7C2EF, Logic switch {
                ...
                new Location(this, 131, "Missile (Wrecked Ship top)", LocationType.Visible, 0x7C319),
                new Location(this, 132, "Energy Tank, Wrecked Ship", LocationType.Visible, 0x7C337, Logic switch {
                ...
                new Location(this, 133, "Super Missile (Wrecked Ship left)", LocationType.Visible, 0x7C357),
                new Location(this, 134, "Right Super, Wrecked Ship", LocationType.Visible, 0x7C365),
                new Location(this, 135, "Gravity Suit", LocationType.Chozo, 0x7C36D, Logic switch {
                    Casual => items => items.Has(Grapple) || items.Has(SpaceJump) || items.Has(Varia) && items.HasEnergyReserves(2) || items.HasEnergyReserves(3),
                    _ => new Requirement(items => items.Has(Varia) || items.HasEnergyReserves(1))
                })
            };
