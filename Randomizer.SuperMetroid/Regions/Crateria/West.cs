    ...
    class West : Region {
        ...
        public West(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, 8, "Energy Tank, Terminator", LocationType.Visible, 0x78432),
                new Location(this, 5, "Energy Tank, Gauntlet", LocationType.Visible, 0x78264, Logic switch {
                ...
                new Location(this, 9, "Missile (Crateria gauntlet right)", LocationType.Visible, 0x78464, Logic switch {
                ...
                new Location(this, 10, "Missile (Crateria gauntlet left)", LocationType.Visible, 0x7846A, Logic switch {
                    Casual => items => CanEnterAndLeaveGauntlet(items) && items.CanPassBombPassages() && items.HasEnergyReserves(2),
                    _ => new Requirement(items => CanEnterAndLeaveGauntlet(items) && items.CanPassBombPassages())
                })
            };
