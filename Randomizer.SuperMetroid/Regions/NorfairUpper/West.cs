    ...
    class West : Region {
        ...
        public West(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, 50, "Ice Beam", LocationType.Chozo, 0x78B24, Logic switch {
                ...
                new Location(this, 51, "Missile (below Ice Beam)", LocationType.Hidden, 0x78B46, Logic switch {
                ...
                new Location(this, 53, "Hi-Jump Boots", LocationType.Chozo, 0x78BAC, Logic switch {
                    _ => new Requirement(items => items.CanOpenRedDoors())
                }),
                new Location(this, 55, "Missile (Hi-Jump Boots)", LocationType.Visible, 0x78BE6, Logic switch {
                    _ => new Requirement(items => items.CanOpenRedDoors() && items.CanPassBombPassages())
                }),
                new Location(this, 56, "Energy Tank (Hi-Jump Boots)", LocationType.Visible, 0x78BEC, Logic switch {
