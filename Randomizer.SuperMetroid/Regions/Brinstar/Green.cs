    ...
    class Green : Region {
        ...
        public Green(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, "Power Bomb (green Brinstar bottom)", LocationType.Chozo, 0x784AC, Logic switch {
                    _ => new Requirement(items => items.CanUsePowerBombs())
                }),
                new Location(this, "Missile (green Brinstar below super missile)", LocationType.Visible, 0x78518, Logic switch {
                    _ => new Requirement(items => items.CanPassBombPassages() && items.CanOpenRedDoors())
                }),
                new Location(this, "Super Missile (green Brinstar top)", LocationType.Visible, 0x7851E, Logic switch {
                ...
                new Location(this, "Reserve Tank, Brinstar", LocationType.Chozo, 0x7852C, Logic switch {
                    Casual => items => items.CanOpenRedDoors() && items.Has(SpeedBooster),
                    _ => new Requirement(items => items.CanOpenRedDoors() && (items.Has(Morph) || items.Has(SpeedBooster)))
                }),
                new Location(this, "Missile (green Brinstar behind missile)", LocationType.Hidden, 0x78532, Logic switch {
                ...
                new Location(this, "Missile (green Brinstar behind reserve tank)", LocationType.Visible, 0x78538, Logic switch {
                ...
                new Location(this, "Energy Tank, Etecoons", LocationType.Visible, 0x787C2, Logic switch {
                    _ => new Requirement(items => items.CanUsePowerBombs())
                }),
                new Location(this, "Super Missile (green Brinstar bottom)", LocationType.Visible, 0x787D0, Logic switch {
