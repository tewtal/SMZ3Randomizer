...
export class Multiworld extends Component {
    ...
    async handleRegisterPlayer(clientGuid) {
        ...
        try {
            ...
            let world = null;
            for (let i = 0; i < this.state.sessionData.seed.worlds.length; i++) {
                if (this.state.sessionData.seed.worlds[i].worldId === client.worldId) {
                    world = this.state.sessionData.seed.worlds[i];
                }
            }                            
                ...
                if (this.state.clientData === null) {
                    ...
                    if (sessionGuid === this.state.sessionId && clientGuid !== null && clientGuid !== "") {
                        ...
                        if (client !== null) {
                            ...
                            this.setState({ clientData: client, sessionInfo: "Session found, registered as player: " + client.name, world: world });
                        }
                    }
                }
