    ...
    class Green : Region {
        ...
        public Green(World world, Logic logic) : base(world, logic) {
            Locations = new List<Location> {
                new Location(this, 13, 0x784AC, LocationType.Chozo, "Power Bomb (green Brinstar bottom)", Logic switch {
                    _ => new Requirement(items => items.CanUsePowerBombs())
                }),
                new Location(this, 15, 0x78518, LocationType.Visible, "Missile (green Brinstar below super missile)", Logic switch {
                    _ => new Requirement(items => items.CanPassBombPassages() && items.CanOpenRedDoors())
                }),
                new Location(this, 16, 0x7851E, LocationType.Visible, "Super Missile (green Brinstar top)", Logic switch {
                ...
                new Location(this, 17, 0x7852C, LocationType.Chozo, "Reserve Tank, Brinstar", Logic switch {
                    Casual => items => items.CanOpenRedDoors() && items.Has(SpeedBooster),
                    _ => new Requirement(items => items.CanOpenRedDoors() && (items.Has(Morph) || items.Has(SpeedBooster)))
                }),
                new Location(this, 18, 0x78532, LocationType.Hidden, "Missile (green Brinstar behind missile)", Logic switch {
                ...
                new Location(this, 19, 0x78538, LocationType.Visible, "Missile (green Brinstar behind reserve tank)", Logic switch {
                ...
                new Location(this, 30, 0x787C2, LocationType.Visible, "Energy Tank, Etecoons", Logic switch {
                    _ => new Requirement(items => items.CanUsePowerBombs())
                }),
                new Location(this, 31, 0x787D0, LocationType.Visible, "Super Missile (green Brinstar bottom)", Logic switch {
